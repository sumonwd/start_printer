...
import 'package:start_printer/src/enums.dart';
import 'package:start_printer/src/portInfo.dart';
import 'package:start_printer/src/print_commands.dart';
import 'package:start_printer/src/utilities.dart';
import 'printer_response_status.dart';

/// Class to handle printer communication
class StarPrnt {
  static const MethodChannel _channel = MethodChannel('start_printer');
